 ...
 */
package com.razorfish.fluent.contentintelligence.it.launcher;
...
implements SlingRemoteTestParameters, SlingTestsCountChecker {
    ...
    public static final String TEST_SELECTOR = "com.razorfish.fluent.contentintelligence.it.tests";
